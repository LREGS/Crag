...
func TotalParam(Rawforecast map[string]interface{}) (FeatureCollection, error) {
	var forecast FeatureCollection

	jsonString, err := json.Marshal(Rawforecast)
	if err != nil {
		return FeatureCollection{}, err
	}

	err = json.Unmarshal(jsonString, &forecast)
	if err != nil {
